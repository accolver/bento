...
- [x] Configure build_runner options if needed
- [x] Set up combined builder for efficiency
...
- [x] Configure pub dependency updates
- [x] Configure GitHub Actions updates
...
- [x] Add code generation instructions
